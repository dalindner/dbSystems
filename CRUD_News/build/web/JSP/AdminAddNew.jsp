    ...
    <body>
        ...
        <div style="width: 900px; margin-left: 40%; margin-right: auto">
            <form name="myForm" action="/DbSystems/admins" onsubmit="return validateForm()" method="post">
                ...
                <br><br>
                *AdminId: <br>
                <input type="text" name="AdminId" style="width: 200px" required><br>
                *EventName: (any)<br>
                <input type="text" name="Event name" style="width: 200px" required><br>
                *EventZip: (any)<br>
                <input type="text" name="Event zip" style="width: 200px" required><br>
                *EventType: (any)<br>
                <input type="text" name="Event Type" style="width: 200px" required><br>
        ...
        function validateForm() {
            ...
            var x = document.forms["myForm"]["Event name"].value;
            if (isNaN(x)) {
                message = message + "Invalid AdminId \n";
            }
            var x = document.forms["myForm"]["Event zip"].value;
            if (isNaN(x)) {
                message = message + "Invalid AdminId \n";
            }
            var x = document.forms["myForm"]["Event Type"].value;
            if (isNaN(x)) {
                message = message + "Invalid AdminId \n";
            }
