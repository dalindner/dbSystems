...
<html>
    ...
    <body>
        ...
        <div class="content" >
            ...
            <div id="demo2" style="width:40%;position:absolute;left:8% ">
            ...
            <table>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${Unmatched}" var="q">
                            
                        <c:set var="donationId" value="${q.donationId}"/>
                        <% donationId = pageContext.getAttribute("donationId").toString(); %>
                                                      
                            <tr>
                                <td>${q.item_name}</td>
                                <td>${q.description}</td>
                                    <c:forEach items="${AllSupportTypes}" var="p">
                                        <c:if test="${q.category == p.supportType_id}">
                ...
                <div id="demo" style="width:40%;position:absolute;left:52%">
            ...
            <% String quantity = pageContext.getAttribute("quantity").toString(); %>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${AllData}" var="q">
                            <tr>
                                ...
                                <td>${q.quantity}</td>
                                <td><a href="/DbSystems/Link?id=<%=donationId%>&id2=${q.item_id_fk}&emailR=${q.email}&requestedName=<%=name%>&requestedQuantity=<%=quantity%>&donatedName=${q.requestedItem}&donatedQuantity=${q.quantity}">Select</a></td>
                            </tr>
                        </c:forEach>   
                    </tbody>
            </table></div>
