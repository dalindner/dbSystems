            ...
            <button type="button" class="reset">Reset Search</button>
                    ...
                    <thead>
                            <tr>
                                    ...
                                    <th>Zip Code</th>
                                    <th>Phone Number</th>
                                    <th>Call Center address</th>
                                    <th>Active or not</th>
                                    <th>Event handling</th>
                                    <th>Want Delete It?</th>
                                
                            </tr>
                    </thead>
                    <tbody>

                        <c:forEach items="${AllCC}" var="q">
                            <c:forEach items="${AllEvent}" var="p">
                                
                            <c:if test="${q.event_id == p.eventId}">
                            ...
                            <tr>
                                ...
                                <td>${q.cc_phone}</td>
                                <td>${q.cc_address}</td>
                                <c:if test="${q.active == 1}">
                                <td>Active</td>
                                </c:if>
                                <c:if test="${q.active == 0}">
                                <td>Not Active</td>
                                </c:if>
                                
                                
                                <td>${p.eventName}</td>
                                <td><a href="/DbSystems/CCDelete?cc_id=${q.cc_id}">Delete Call Center</a></td>
                            </tr>
