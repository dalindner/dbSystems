...
public class ViewTwo {
    ...
    public ViewTwo(int supportType_id_fk, int event_id_fk, String requestedItem, String item_category, int quantity, String description, String name, String email, int item_id_fk, int requests_id_fk, String event_name) {
