...
public class EventEdit extends HttpServlet {
    ...
    {
        int Temp = Integer.parseInt(request.getParameter("eventid"));
        EventDataAccess da = new EventDataAccess();
        request.setAttribute("TheEvent", da.getEventById(Temp));
        request.setAttribute("AllEvents", EventDataAccess.getAllEvent());
        RequestDispatcher rd = request.getRequestDispatcher("JSP/ModifyEvents.jsp");
